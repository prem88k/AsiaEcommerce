...
class SellerPolicyPage extends StatefulWidget{
  static const routeName = '/SellerPolicyPage';
...
class AbountPocketusePageState extends State<SellerPolicyPage>{
...
//        ),
        ...
        title: CommonWidget.getActionBarTitleText(title.isEmpty ? 'Seller Policy': title),
  ...
  Future<void> getdata() async {
    ...
    var url = Uri.https(GlobalConfiguration().getString('url'),'/api/front/page/seller-policy');
