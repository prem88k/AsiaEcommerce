...
//          ))
  ...
  Future<void> editProfileAPiCall() async {
    var url = Uri.https(
        GlobalConfiguration().getString('url'), '/api/user/profile/update');
    print('url $url');
...
//      var CommanModal_obj = new CommanModal.fromJsonMap(userMap) as CommanModal;
      if (userMap["status"]) {
        ...
        var CommanModal_obj =
            new ProfileEditResponse.fromJsonMap(data) as ProfileEditResponse;

        MyPreferenceManager _myPreferenceManager =
            await MyPreferenceManager.getInstance();

        _myPreferenceManager.setString(MyPreferenceManager.LOGIN_USER_NAME,
            CommanModal_obj.full_name.toString());
        Consts.current_username =
            _myPreferenceManager.getString(MyPreferenceManager.LOGIN_USER_NAME);

        _myPreferenceManager.setString(MyPreferenceManager.LOGIN_USER_EMAIL,
            CommanModal_obj.email.toString());
        Consts.current_useremail = _myPreferenceManager
            .getString(MyPreferenceManager.LOGIN_USER_EMAIL);
