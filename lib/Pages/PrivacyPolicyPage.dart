...
class AbountPocketusePageState extends State<PrivacyPolicyPage>{
...
//        ),
        ...
        title: CommonWidget.getActionBarTitleText(title.isEmpty ? "Privacy & Policy": title),
  ...
  Future<void> getdata() async {
    var url = Uri.https(GlobalConfiguration().getString('url'),'/api/front/page/privacy-policy');
    print('url $url');
