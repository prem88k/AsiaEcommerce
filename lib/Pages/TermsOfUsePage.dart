...
class TermsOfUsePage extends StatefulWidget{
  static const routeName = '/TermsOfUsePage';
...
class AbountPocketusePageState extends State<TermsOfUsePage>{
...
//        ),
        ...
        title: CommonWidget.getActionBarTitleText(title.isEmpty ? "Terms & Condition": title),
  ...
  Future<void> getdata() async {
    var url = Uri.https(GlobalConfiguration().getString('url'),'/api/front/page/terms-of-use');
