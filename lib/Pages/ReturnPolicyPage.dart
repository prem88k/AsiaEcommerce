...
class ReturnPolicyPage extends StatefulWidget{
  static const routeName = '/ReturnPolicyPage';
...
class AbountPocketusePageState extends State<ReturnPolicyPage>{
...
//        ),
        ...
        title: CommonWidget.getActionBarTitleText(title.isEmpty ? 'Returns Policy': title),
  ...
  Future<void> getdata() async {
    var url = Uri.https(GlobalConfiguration().getString('url'),'/api/front/page/returns-policy');
